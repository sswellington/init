#!/bin/bash
#Init: Readme
# Template para o arquivo README.md, inspirado pelo site readme.so
# O template contém o nome do projeto, descrição, documentação e referência.
...
## Referência
'links ou artigos usado no projeto'" > README.md
